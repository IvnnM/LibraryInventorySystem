        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 overflow-y-scroll p-4">
          ...
          <div class="container-fluid table"  id="bookpage" style="padding: 0;">
            <div class="d-flex justify-content-between">
                <h5>Books Lists</h5>
                <div class="d-flex" >
                  <select class="form-select sort" id="authorDropdown" aria-label="Sort by Author">
                  ...
                  <select class="form-select sort" id="genreDropdown" aria-label="Sort by Genre">
                ...
                <form class="d-flex" style="margin-bottom: 5px;" id="sort">
